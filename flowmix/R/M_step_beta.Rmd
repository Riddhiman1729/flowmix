...
#  calculate_dens(iclust=1, tt=27, ylist[[27]],
#                    mn, sigma,  
#                    censor_indicator_left[[27]], ##the left censoring indicator at time tt in the list
#                    censor_indicator_right[[27]], ##the right censoring indicator at time tt in the list
#                    cens_lim_l_vec,
#                    cens_lim_u_vec,                             
#                    denslist_by_clust, 
#                    first_iter)
...
#'@param resp responsibility list
#'@param resp.sum responsibility aggregated per cluster
#'@param ylist list of all responses 
#'@return list of weghted responses,, weighted response sums, mean of responses, centered responses
...
estepy_saved =  Estep_y(y=ylist,X,censor_indicator_left=cens_ind_left, 
...
resp = Estep(mn_array, sigma_array, pmat, ylist,
...
#debug(Mstep_beta_admm)

library('Rcpp')
library(RcppArmadillo)
sourceCpp('C://Users//16128//Documents//Sangwon_Project//Codes//syl.cpp')

Mstep_beta_admm(resp,
                ylist,ynew=y_new,
                X,
                mean_lambda = 0,
                aperm(simplify2array(Sig_list),perm=c(3,1,2)),
                sigma_eig_by_clust = NULL,
                first_iter = TRUE,
                censor_indicator_left = cens_ind_left ,
                censor_indicator_right = cens_ind_right,
